...
NTSTATUS
GAMO2FB9USBUMDF2DriverQueueInitialize(
...
--*/
{
    ...
    queueConfig.EvtIoDeviceControl = GAMO2FB9USBUMDF2DriverEvtIoDeviceControl;
    queueConfig.EvtIoStop = GAMO2FB9USBUMDF2DriverEvtIoStop;
...
VOID
GAMO2FB9USBUMDF2DriverEvtIoDeviceControl(
    _In_ WDFQUEUE Queue,
...
VOID
GAMO2FB9USBUMDF2DriverEvtIoStop(
    _In_ WDFQUEUE Queue,
    _In_ WDFREQUEST Request,
